...
my $sim_truth_set = "$FindBin::Bin/pbsim3_wreps.truthset.rep1.TSV";
...
main: {
    ...
    # plot PR AUC summary
    $cmd = "./util/plot_all_PR_AUC_vs_pass_n_cov.Rscript";
    $pipeliner->add_commands(new Command($cmd, "plot_all_PR_AUC_vs_pass_n_cov.ok"));
    
    $cmd = "./util/plot_breakpoint_PR_AUC.Rscript";
    $pipeliner->add_commands(new Command($cmd, "plot_breakpoint_PR_AUC.ok"));
